...
Dessa alternativ finns på sidan Överför under Bildredigeringsalternativ.
...
Om du vill skapa en mask för bilden baserat på dess urklippsbaneinformation klickar du på **[!UICONTROL Create Mask From Clipping Path]**. Det här alternativet gäller bilder som skapats med bildredigeringsprogram där en urklippsbana har skapats.
