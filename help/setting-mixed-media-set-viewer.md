...
1. Gör något av följande på sidan Förinställningar för visningsprogram:
   ...
   * Om du vill skapa en förinställning klickar du på **[!UICONTROL Add]**. Välj en plattform i dialogrutan Lägg till visningsförinställning, välj **[!UICONTROL Mixed Media Set Viewer]** och klicka sedan på **[!UICONTROL Add]**.
   * Om du vill redigera en förinställning för visningsprogrammet för blandad medieuppsättning markerar du den och klickar sedan på **[!UICONTROL Edit]**.
...
1. Om du vill redigera förinställningslistan gör du något av följande:
   ...
   * Om du vill ta bort en förinställning från listan markerar du den och klickar sedan på **[!UICONTROL Delete]**.
   * Om du vill ändra ordningen på förinställningarna i listan markerar du en förinställning och klickar på den blå pilen **[!UICONTROL Up]** eller **[!UICONTROL Down]**.
...
1. Om du vill lägga till communityfunktioner (Bädda in, Länk, Besök) i visningsprogrammet anger du alternativ för något av följande:
   ...
   * **E-post** - Klicka  **[!UICONTROL On]** för att aktivera en e-postknapp i visningsprogrammet. När användarna klickar på knappen E-post när de visar uppsättningen öppnas ett e-postmeddelande med länken till uppsättningen.

   * **Bädda in**  - klicka  **[!UICONTROL Live]**. I rutan Bädda in knappetikett skriver du det namn som du vill ska visas i visningsprogrammet för knappen Bädda in. Om du vill kan du klicka på **[!UICONTROL Browse]** för att hitta och välja ett anpassat skal för knappen.

   * **Link** - Click  **[!UICONTROL Live]**. Skriv det namn som du vill ska visas i visningsprogrammet för knappen Länk i rutan Länkknappsetikett. Om du vill kan du klicka på **[!UICONTROL Browse]** för att hitta och välja ett anpassat skal för knappen.

   * **Besök**  - klicka  **[!UICONTROL Live]**. I rutan Besök knappetikett skriver du det namn som du vill ska visas i visningsprogrammet för knappen Besök. I rutan Besök URL skriver du URL-adressen till den webbplats som du vill öppna när du klickar på länken.
