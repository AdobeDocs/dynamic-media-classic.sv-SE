...
Om du vill öka skärpan i en bild klickar du på dess överrullning **Redigera** och väljer Skärpa, eller öppnar den i panelen Bläddra i vyn Detalj och klickar sedan på **Skärpa**. Skärmen för skärperedigeraren öppnas med skärpekommandon. Välj kommandon och klicka på **Spara**.
...
**** IngenInaktiverar skärpa.

**Öka skärpanSkapar en enkel** förbättring av filens skärpa när storleken har ändrats. Detta liknar &quot;Skärpa&quot;-filtret i Photoshop och stöder alla användarparametrar. Normalt använder du det här filtret eller Oskarp mask, men inte båda. Det är en god praxis att inte rekommendera den här metoden, men den kan kompensera för oskärpa. (URL: op_sharpen)

**Oskarp** maskAnvänds för att finjustera en skärpefiltereffekt på den slutliga nedsamplade bilden. Du kan styra effektens intensitet, radie (mätt i pixlar) och ett kontrasttröskelvärde som ska ignoreras. Effekten har samma alternativ som filtret Oskarp mask i Photoshop. (URL: op_usm)

Välj följande alternativ för att finjustera skärpan med Oskarp mask:

**Mängd** Styr mängden kontrast som används på kantpixlar. Standardvärdet är 0,0. För högupplösta bilder kan du öka den till upp till 5.0. Tänk på Mängd som ett mått på filterintensiteten. Observera att inställningen Mängd i Dynamic Media Classic inte är densamma som inställningen Mängd i Photoshop. Photoshop använder ett värde mellan 1 % och 500 %, medan Dynamic Media Classic skalar från 0,0 till 5,0. (5.0 motsvarar ungefär 500 % i Photoshop, 0,9 motsvarar 90 % och så vidare.)

**** RadieAnger antalet pixlar runt kantpixlarna som påverkar skärpan. Effekten körs på alla pixlar i bilden och strålar ut i alla riktningar.
...
**Använd** ToChoose för varje färg om du vill använda skärpa separat för varje färgkomponent, Välj Intensitet om du vill använda skärpa i bildernas intensitetsområden.
...
**Bikubisk** ökning av processoranvändningen på bildservern, men ger skarpare bilder med mindre framträdande aliasing-artefakter.

**Skärpa2** kan ge något tydligare resultat än bikubisk, men till ännu högre processorkostnad för Image Server.

**** TrilinearAnvänder både högre och lägre upplösningar om sådana finns. rekommenderas bara när alias är ett problem. Den här metoden minskar JPEG-storleken på grund av reducerade högfrekventa data.
...
**JPG-** kvalitetVälj det här alternativet om du vill styra komprimeringsnivåer och krominansnedsampling.
