...
**Så här ställer du in en svarsmall:**

1. Dubbelklicka på bilduppsättningen för att öppna den i detaljvyn.
1. Klicka på **[!UICONTROL InfoPanel Setup]**.
...
1. Klicka på **[!UICONTROL Upload]** om du vill överföra innehållet i informationspanelen, baserat på rollover_key-värden, till s7info.
1. I dialogrutan S7Info Upload bläddrar du till filen som du vill använda och klickar sedan på **[!UICONTROL Upload]**.
...
1. Dubbelklicka på bilduppsättningen för att öppna den i detaljvyn.
1. Klicka på **[!UICONTROL InfoPanel Datafeed]**.
1. I textfältet Externt hosted CSV file location (HTTP) anger du URL:en till CSV-filen.
1. (Valfritt) I fälten Schemalägg uppdatering anger du en tid för att uppdatera innehållet och klickar sedan på **[!UICONTROL Add]**.

   Du kan välja flera gånger för uppdatering. Varje uppdateringstid visas i textrutan Uppdateringstider. Om du vill ta bort en schemalagd tid markerar du den och klickar sedan på **[!UICONTROL Delete]**.

1. (Valfritt) Klicka på **[!UICONTROL Run Update]** för att omedelbart uppdatera innehållet.
