...
När du publicerar placeras din e-katalog och PDF på dynamiska mediabildsservrar så att den kan göras tillgänglig för din webbplats eller ditt program. Som en del av publiceringsprocessen aktiverar Scene7 Publishing System URL-strängen. Du kan placera den här URL-strängen i HTML-webbsideskoden.
...
Så här publicerar du din e-katalog till dynamiska mediabildsservrar:
