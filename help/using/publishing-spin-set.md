...
Om du vill publicera en snurruppsättning som dynamiska mediabildsservrar väljer du **[!UICONTROL Publish]** i fältet Global navigering. Välj sedan ett **[!UICONTROL When]**-alternativ. Du kan också ange ett namn för publiceringsjobbet. Välj **[!UICONTROL Submit Publish]**.
