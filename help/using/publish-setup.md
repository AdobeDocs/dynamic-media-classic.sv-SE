...
* **[!UICONTROL Localization Support]**: Med de här inställningarna kan du hantera flera språkattribut. Här kan du också ange en sträng för språkområdeskarta så att du kan definiera vilka språk du vill ha stöd för de olika verktygstipsen i visningsprogram.
  ...
  >[!NOTE]
  > [Använd Admin Console för att skapa ett supportärende om du vill ställa in alternativ för lokaliseringsstöd.](https://helpx.adobe.com/enterprise/using/support-for-experience-cloud.html) I ditt supportärende, begär du hjälp med installationen.
...
>[!NOTE]
>
>Om du vill ställa in alternativ för lokaliseringsstöd i Adobe Dynamic Media Classic, t.ex. fältet för språkområdet, [använder du Admin Console för att skapa ett supportärende.](https://helpx.adobe.com/enterprise/using/support-for-experience-cloud.html) I ditt supportärende, begär du hjälp med installationen.
