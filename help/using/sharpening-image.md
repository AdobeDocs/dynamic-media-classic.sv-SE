...
Om du vill göra en bild skarpare väljer du dess överrullning **[!UICONTROL Edit]** och välj **[!UICONTROL Sharpen]** eller öppna den i panelen Bläddra i detaljvyn och markera sedan **[!UICONTROL Sharpen]**. Sidan Skärperedigeraren öppnas med skärpekommandon. Välj de kommandon du vill använda och klicka sedan på **[!UICONTROL Save]**.
...
* **Tröskelvärde**: Avgör det kontrastintervall som ska ignoreras när filtret Oskarp mask används. Med det här alternativet anger du hur olika skärpepixlarna måste vara från det omgivande området innan kantpixlarna blir skarpare.
