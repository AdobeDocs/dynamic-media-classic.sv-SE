...
URL-strängar som skapas med bildförinställningar innehåller namnet på en bildförinställning. Namnet omges av dollartecken (`$`). Till exempel: `$thumbnail$` kan vara den förinställda bilden som är utformad för att visa primära bilder i miniatyrstorlek. Se [Länka URL:er till webbprogrammet](linking-urls-web-application.md#linking_urls_to_your_web_application).
