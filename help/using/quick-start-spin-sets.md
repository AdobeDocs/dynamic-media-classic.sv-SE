...
När du publicerar en snurruppsättning placeras den på Adobe Dynamic Media Classic-servrar så att den kan levereras dynamiskt till din webbplats eller ditt program. Den aktiverar även URL-strängen som anropar den snurrande uppsättningen från dynamiska mediabildsservrar till din webbplats eller ditt program.
