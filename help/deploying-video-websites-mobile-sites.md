...
Webbplatser, mobilsajter och datorprogram får tillgång till dynamiskt Media Classic-serverinnehåll, inklusive video, via URL-strängar eller inbäddad kod. Dynamic Media Classic aktiverar dessa URL-strängar under publiceringsprocessen. Om du vill placera URL-strängen eller inbäddningskoden för videon på webbsidor, mobilsidor och datorprogram kopierar du den från Dynamic Media Classic.
...
* **Publicera videoklipp automatiskt och direkt vid överföring**
   ...
   Som en del av videoöverföringen kan Dynamic Media Classic automatiskt publicera videor när de överförs och kodas. Möjligheten att publicera direkt innebär att man inte behöver publicera videor separat efter det att man gjort det.
