...
seo-title: Länka en färgruteuppsättning till en webbsida
description: 'null'
seo-description: Lär dig hur du länkar en uppsättning med färgrutor till en webbsida.
...
Mer information och kodexempel finns i [Bädda in HTML5 Zoom Viewer i Adobe Viewer Reference Guide](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/c_html5_20_zoom_viewer_about.html).
